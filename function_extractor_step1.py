...
from r import read_directory_recursive
# assume only file names could be possible module names within a package
#def get_possible_module_names(package_path):
#    directories = os.
import os

from r import read_file
package_directory = "/media/xiyao/Xiyao8T/Program_SidechainPrediction"
